      ...
      <PageHeader
        ...
        actions={
          <>
            ...
            <HelpButton title="What are Factory connections?">
              <p>
              ...
              <p>
                ...
                view sums each block&apos;s output per item, which can <em>hide</em> a real problem:
                if block A overproduces iron by +5 and block B is 5 short, the totals cancel to
                &quot;balanced <Check className="inline size-3.5" />
                &quot; — but the wiring is broken (B is starved, A backs up). Connections shows each
